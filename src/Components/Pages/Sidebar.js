...
const Sidebar = () => {
  ...
  return (
    <div>
      <div className= { toggle ? "md:bg-[#003F5A] md:w-[60px] md:h-[100vh] md:fixed md:z-20 md:top-[108px] md:block hidden" :"hidden"}>
      ...
      <div className={ !toggle ? "bg-[#003F5A] w-[200px] h-[100vh] fixed z-20": "hidden"}>
