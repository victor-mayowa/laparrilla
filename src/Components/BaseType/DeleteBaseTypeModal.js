...
const DeleteBaseTypeModal = () => {
    ...
    const confirmBaseTypeDelete = dataCtx.confirmBaseTypeDelete 
      ...
      >
        <div className="bg-white rounded-lg relative">
          ...
          <div className="w-[400px] h-[180px] p-2 flex flex-col justify-center items-center mt-3">
            ...
            <div className="mt-4">
              <button onClick={confirmBaseTypeDelete }  className="bg-green-800 text-white px-4 py-1 rounded-lg cursor-pointer hover:bg-green-700 mr-8">
                Yes
              </button>
